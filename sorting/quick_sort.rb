# highly efficient divide-and-conquer sorting algorithm.
# It selects a "pivot" element, then partitioning the array so that:
# All elements less than the pivot come before it,
# All elements greater than the pivot come after it.
# This process is recursively applied to the left and
# right subarrays until the entire array is sorted.
